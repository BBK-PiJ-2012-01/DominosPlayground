...
public class AbstractStateEnumeratorTest {
    ...
    public void testGetValidInitialChoices() throws Exception {
        List<Choice> choices = stateEnumerator.getValidInitialChoices(new LinkedList(bones));
    ...
    public void testGetValidPlacingChoices() throws Exception {
        ...
        for (Choice choice : stateEnumerator.getValidPlacingChoices(new LinkedList(bones), left, right)) {
    ...
    public void testGetValidPickupChoices() throws Exception {
        ...
        for (Choice choice : stateEnumerator.getValidPickupChoices(new LinkedList(bones))) {
